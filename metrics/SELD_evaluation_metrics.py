...
class SELDMetrics(object):
    def \
            __init__(self, doa_threshold=20, nb_classes=14):
        '''
...
## no need , ## check ##
class SELDMetrics_custom(SELDMetrics):
    def __init__(self, doa_threshold=20, nb_classes=14, frames_per_1s=10):
        super().__init__(doa_threshold, nb_classes)
        self._nb_label_frames_1s = frames_per_1s
